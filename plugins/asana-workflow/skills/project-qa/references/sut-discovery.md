...
The SUT (System Under Test) is a running application — either a local dev server or a remote staging/production URL. The skill must identify it before investigation begins.
