...
- **Coordinates from bounds** — all gestures are coordinate-based. Get element bounds from `mobile_list_elements_on_screen`, calculate center: `x + width/2`, `y + height/2`. Never hardcode coordinates.
